      ...
      <div className='article-container'>
        <div>
          ...
          <p className='deck'>
            ...
            artistic. I want whatever I build to have personality.
          </p>
          <img src={meadow} alt='Meadow' />
          <p className='body'>
            To me, the best way to begin working on a new design is to simply
            start from a few ideas and find out what works. I think that tools
            like Figma have a lot to offer teams working on larger scale but
            that critical aspects are bound to get lost in translation when
            porting designs over to the production environment, making it
            difficult to ensure quality, as well as effectivity.
          </p>
          <p>
